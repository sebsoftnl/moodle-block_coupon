...
$title = $heading = get_string('view:downloadbatches:title', 'block_coupon');

$page = couponpage::setup(
    'block_coupon_view_downloadbatchlist',
    $title,
    couponpage::get_view_url('downloadbatchlist.php'),
...
$controller = new block_coupon\controller\downloadbatches($PAGE, $OUTPUT, $renderer);
