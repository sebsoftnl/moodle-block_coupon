...
$title = get_string('tab:report', 'block_coupon');
$heading = get_string('tab:report', 'block_coupon');

$url = couponpage::get_view_url('my/reports.php');
$page = couponpage::setup(
    'block_coupon_view_my_reports',
    $title,
    $url,
    [],
...
$controller = new \block_coupon\controller\my\reports($PAGE, $OUTPUT, $renderer);
