...
$PAGE->navbar->add(get_string('page:generate_coupon.php:title', 'block_coupon'));

$url = new moodle_url($CFG->wwwroot . '/blocks/coupon/view/generate_coupon.php', array('id' => $id));
$PAGE->set_url($url);
...
echo $renderer->page_coupon_generator();