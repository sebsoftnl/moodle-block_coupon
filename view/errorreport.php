...
$title = get_string('view:errorreport:title', 'block_coupon');
$heading = get_string('view:errorreport:heading', 'block_coupon');

$page = couponpage::setup(
    'block_coupon_view_errorreport',
    $title,
    couponpage::get_view_url('errorreport.php'),
