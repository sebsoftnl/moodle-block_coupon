...
$url = new moodle_url($CFG->wwwroot . '/blocks/coupon/view/extendenrolment_step3.php', array('id' => $id, 'cid' => $cid));
$PAGE->set_url($url);

$PAGE->set_title(get_string('view:extendenrolment_step3:title', 'block_coupon'));
$PAGE->set_heading(get_string('view:extendenrolment_step3:heading', 'block_coupon'));
...
echo $renderer->page_extendenrolment_wizard_step3($cid);