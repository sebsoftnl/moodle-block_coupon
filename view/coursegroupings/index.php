...
$title = 'view:coursegroupings:admin:title';
$heading = 'view:coursegroupings:admin:heading';

$PAGE->navbar->add(get_string($title, 'block_coupon'));

$url = new moodle_url($CFG->wwwroot . '/blocks/coupon/view/coursegroupings/index.php', array('id' => $id));
$PAGE->set_url($url);
