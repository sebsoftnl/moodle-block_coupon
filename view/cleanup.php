...
$title = get_string('view:cleanup:title', 'block_coupon');
$heading = get_string('view:cleanup:heading', 'block_coupon');

$page = couponpage::setup(
    'block_coupon_view_cleanup',
    $title,
    couponpage::get_view_url('cleanup.php'),
