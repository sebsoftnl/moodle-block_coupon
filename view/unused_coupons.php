...
$PAGE->navbar->add(get_string('view:reports-unused:title', 'block_coupon'));

$url = new moodle_url('/blocks/coupon/view/unused_coupons.php', array('id' => $id));
$PAGE->set_url($url);

$PAGE->set_title(get_string('view:reports-unused:title', 'block_coupon'));
$PAGE->set_heading(get_string('view:reports-unused:heading', 'block_coupon'));
