...
/**
 * coupon generator step 3
 *
 * File         generate_coupon_step_three.php
 * Encoding     UTF-8
 *
...
$PAGE->navbar->add(get_string('page:generate_coupon_step_three.php:title', 'block_coupon'));

$url = new moodle_url($CFG->wwwroot . '/blocks/coupon/view/generate_coupon_step_three.php', array('id' => $id));
$PAGE->set_url($url);
...
echo $renderer->page_coupon_generator_step3();