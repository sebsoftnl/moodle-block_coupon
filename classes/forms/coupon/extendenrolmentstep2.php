...
/**
 * Enrolment extension coupon generator form (first step)
 *
 * File         extendenrolmentstep3.php
 * Encoding     UTF-8
 *
...
/**
 * block_coupon\forms\extendenrolmentstep3
 *
 * @package     block_coupon
 *
 * @copyright   Sebsoft.nl
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class extendenrolmentstep2 extends \moodleform {
    ...
    protected function definition() {
        ...
        if (count($users) === 0) {
            // We cannot process.
            $err = $OUTPUT->notify_problem(get_string('extendenrol:abort-no-users', 'block_coupon'));
