...
class editcohorts extends dynamic_form {
    ...
    protected function initialize() {
        ...
        if ($a->claimed > 0) {
            $this->errorlist[] = get_string('err:coupon:editcohorts:nclaimed', 'block_coupon', $a);
        }
        ...
        if (count($a->typs) > 0) {
            ...
            $this->errorlist[] = get_string('err:coupon:editcohorts:ntypes', 'block_coupon', implode(', ', $b));
        }
    }
