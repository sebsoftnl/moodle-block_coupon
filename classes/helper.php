...
class helper {
    ...
    final public static function mail_coupons($coupons, $emailto, $generatesinglepdfs = false,
            $emailbody = false, $initiatedbycron = false, $batchid = null, $font = 'helvetica') {
        global $DB, $CFG;
        ...
        list($filename, $relativefilename) = static::generate_coupons($coupons,
                $generatesinglepdfs, $batchid, $ts, $font);
     ...
     * @param string $font default font to apply for the PDF
     *
     * @return array of 0: relative filename, 1: full pathname
     */
    protected static function generate_coupons($coupons, $generatesinglepdfs, $batchid, $ts, $font = 'helvetica') {
        global $CFG;
